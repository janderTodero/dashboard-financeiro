...
export default function ImportBankStatement() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await api.post("/transactions/import-bank-statement", formData, {
                headers: { "Content-Type": "multipart/form-data" },
            });
            await refreshTransactions();
            setStatus({ type: "success", message: "Importação de extrato realizada com sucesso!" });
            setArquivo(null);
        } catch (error) {
            console.error(error);
            setStatus({ type: "error", message: "Erro ao importar o extrato. Verifique o formato." });
        } finally {
            setLoading(false);
        }
    };
                                    ...
                                    {!arquivo ? (
                                        <div className="text-center p-6 pointer-events-none">
                                            ...
                                            <p className="text-lg font-medium text-gray-200 mb-2">
                                                Arraste e solte seu extrato CSV aqui
                                            </p>
